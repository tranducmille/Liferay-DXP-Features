...
<p>
	...
	<liferay-ui:search-container var="searchContainer"
		...
		<liferay-ui:search-container-row
			className="com.xtivia.book.portlet.model.Book" keyProperty="bookId" modelVar="book">
			...
			<liferay-ui:search-container-column-text name="Delete Book" value="Delete" href="javascript:deleteBookService(${book.bookId})"/>
		</liferay-ui:search-container-row>
