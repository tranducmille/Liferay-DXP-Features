 ...
 * @see com.xtivia.book.portlet.service.persistence.impl.EntryPersistenceImpl
 * @generated
 */
@ProviderType
public class EntryUtil {
	...
	*/
	public static List<Entry> findByB_G(long groupId, long bookId) {
		return getPersistence().findByB_G(groupId, bookId);
	}
	...
	*/
	public static List<Entry> findByB_G(long groupId, long bookId, int start,
		int end) {
		return getPersistence().findByB_G(groupId, bookId, start, end);
	}
	...
	*/
	public static List<Entry> findByB_G(long groupId, long bookId, int start,
		...
		return getPersistence()
				   .findByB_G(groupId, bookId, start, end, orderByComparator);
	}
	...
	*/
	public static Entry findByB_G_First(long groupId, long bookId,
		OrderByComparator<Entry> orderByComparator)
		throws com.xtivia.book.portlet.exception.NoSuchEntryException {
		return getPersistence()
				   .findByB_G_First(groupId, bookId, orderByComparator);
	}
	...
	*/
	public static Entry fetchByB_G_First(long groupId, long bookId,
		OrderByComparator<Entry> orderByComparator) {
		return getPersistence()
				   .fetchByB_G_First(groupId, bookId, orderByComparator);
	}
	...
	* @throws NoSuchEntryException if a matching entry could not be found
	*/
	public static Entry findByB_G_Last(long groupId, long bookId,
		OrderByComparator<Entry> orderByComparator)
		throws com.xtivia.book.portlet.exception.NoSuchEntryException {
		return getPersistence()
				   .findByB_G_Last(groupId, bookId, orderByComparator);
	}
	...
	*/
	public static Entry fetchByB_G_Last(long groupId, long bookId,
		OrderByComparator<Entry> orderByComparator) {
		return getPersistence()
				   .fetchByB_G_Last(groupId, bookId, orderByComparator);
	}
	...
	*/
	public static Entry[] findByB_G_PrevAndNext(long entryId, long groupId,
		long bookId, OrderByComparator<Entry> orderByComparator)
		throws com.xtivia.book.portlet.exception.NoSuchEntryException {
		return getPersistence()
				   .findByB_G_PrevAndNext(entryId, groupId, bookId,
			orderByComparator);
	}
	...
	* @param bookId the book ID
	*/
	public static void removeByB_G(long groupId, long bookId) {
		getPersistence().removeByB_G(groupId, bookId);
	}
	...
	*/
	public static int countByB_G(long groupId, long bookId) {
		return getPersistence().countByB_G(groupId, bookId);
	}
